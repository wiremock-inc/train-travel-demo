...
export async function bookingsCreateBooking(
    ...
    Result<
        operations.CreateBookingResponse,
        | SDKError
        | SDKValidationError
        | UnexpectedClientError
        | InvalidRequestError
...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(201, operations.CreateBookingResponse$inboundSchema, { key: "Result" }),
        m$.bytes(201, operations.CreateBookingResponse$inboundSchema, {
            ctype: "application/xml",
            key: "Result",
        }),
        m$.fail([400, 401, 404, 409, 429, 500]),
        m$.fail(["4XX", "5XX"])
